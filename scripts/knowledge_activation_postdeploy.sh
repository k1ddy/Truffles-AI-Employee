...
EXPLICIT_CLIENT_SLUG="${KNOWLEDGE_ACTIVATION_CLOSEOUT_CLIENT_SLUG:-}"
EXPLICIT_BRANCH_SLUG="${KNOWLEDGE_ACTIVATION_CLOSEOUT_BRANCH_SLUG:-}"
CLIENT_SLUG="${EXPLICIT_CLIENT_SLUG}"
BRANCH_SLUG="${EXPLICIT_BRANCH_SLUG}"
DEFAULT_CLIENT_SLUG="${KNOWLEDGE_ACTIVATION_CLOSEOUT_DEFAULT_CLIENT_SLUG:-}"
DEFAULT_BRANCH_SLUG="${KNOWLEDGE_ACTIVATION_CLOSEOUT_DEFAULT_BRANCH_SLUG:-}"
...
if [ -n "${EXPLICIT_CLIENT_SLUG}" ] && [ -z "${EXPLICIT_BRANCH_SLUG}" ]; then
  CLIENT_SLUG="${EXPLICIT_CLIENT_SLUG}"
  BRANCH_SLUG=""
elif [ -z "${EXPLICIT_CLIENT_SLUG}" ] && [ -n "${EXPLICIT_BRANCH_SLUG}" ]; then
  CLIENT_SLUG=""
  BRANCH_SLUG="${EXPLICIT_BRANCH_SLUG}"
elif [ -z "${CLIENT_SLUG}" ]; then
  CLIENT_SLUG="${DEFAULT_CLIENT_SLUG}"
fi
if [ -z "${EXPLICIT_CLIENT_SLUG}" ] && [ -z "${EXPLICIT_BRANCH_SLUG}" ] && [ -z "${BRANCH_SLUG}" ]; then
