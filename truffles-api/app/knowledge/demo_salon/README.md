...
- Qdrant sync canonical source: `knowledge/demo_salon/` (default in `ops/sync_client.py` and primary in `ops/manual_sync_demo.py`).
- `ops/demo_salon_docs/` is a legacy copy used only as fallback in `ops/manual_sync_demo.py`.
