...
def handle_resolve(db: Session, conversation: Conversation, manager_id: str, manager_name: str = None) -> Tuple[str, str]:
...
def handle_return(db: Session, conversation: Conversation, manager_id: str, manager_name: str = None) -> Tuple[str, str]:
