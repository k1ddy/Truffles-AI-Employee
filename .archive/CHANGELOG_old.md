...
### Переключение на Python
- Все сообщения WhatsApp → Python API (убран If в 1_Webhook)
- Telegram webhook → Python API
- Исправлен JSON в HTTP Request1 (client_slug динамический)

### Мониторинг
- Скрипт /home/zhan/monitor.sh — проверка /health каждую минуту
- Алерты в Telegram при падении/восстановлении

### Документация
- STRATEGY/REQUIREMENTS.md — страхи, ценности, требования Жанбола
