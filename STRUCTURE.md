...
| `truffles-api/app/routers/webhook/` | Входящие WhatsApp (direct + legacy). Модули: `_legacy.py`, `booking.py`, `context_manager.py`, `decision.py`, `dedup.py`, `guards.py`, `info.py`, `media.py`, `parsing.py`, `pending.py`, `policy.py`, `response.py`, `session_memory.py`, `shield.py`, `trace.py`. |
