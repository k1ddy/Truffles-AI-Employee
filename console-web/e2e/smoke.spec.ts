...
test.describe('Inbox Features', () => {
    ...
    test('should navigate to case detail', async ({ page }) => {
        const openButton = page.getByRole('link', { name: 'Open' }).first();
...
test.describe('Case Actions', () => {
    ...
    test('should send a reply message', async ({ page }) => {
        ...
        if (await openButton.isVisible()) {
            ...
            const replyInput = page.locator('textarea[placeholder*="reply" i], textarea[placeholder*="message" i]');
    ...
    test('should resolve an active case', async ({ page }) => {
        ...
        if (await openButton.isVisible()) {
            ...
            if (await resolveButton.isVisible()) {
                ...
                // Check if we're back at inbox or still on case page
