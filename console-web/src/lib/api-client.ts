...
export type ConsultantVerificationOverviewResponse = {
    ...
    preview_truth_source?: ConsultantVerificationSourceMode | null;
    preview_truth_version_id?: string | null;
    live_truth_version_id?: string | null;
    published_candidate_version_id?: string | null;
    available_source_modes: ConsultantVerificationSourceMode[];
    default_source_mode?: ConsultantVerificationSourceMode | null;
