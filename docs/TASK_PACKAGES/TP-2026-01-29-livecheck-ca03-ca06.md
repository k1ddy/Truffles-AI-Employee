...
## Название/цель
Стабилизировать CA03/CA06 live-check: сохранить trace для info_class и обеспечить short-circuit consult при запросах «совет + цена/время» без генерации новых фактов.
