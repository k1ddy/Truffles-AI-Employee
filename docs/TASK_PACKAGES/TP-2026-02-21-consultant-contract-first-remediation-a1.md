...
- `P9 Contract Test Migration` partial: master long-hair tests migrated to contract meta asserts (`truffles-api/tests/test_info_master_long_hair.py`, checks green as of 2026-03-02) and demo_salon semantic service tests migrated (message_endpoint `semantic_service_matcher/semantic_question_type`, checks green as of 2026-03-02); wave1 slice in `docs/TASK_PACKAGES/TP-2026-03-02-p9-contract-oracle-migration-wave1-a1.md` is complete and superseded, and full remaining closure is tracked in `docs/TASK_PACKAGES/TP-2026-03-02-p9-contract-oracle-full-closure-a1.md`.
...
- `P12 Cross-domain Hardening` partial: deterministic cross-domain suite now covers two non-salon runtime packs (`truffles-api/tests/test_cross_domain_signal_contract_suite.py`) and quality tooling now has matrix non-salon contract gate in `ops/diagnose.py` (`--cross-domain-contract off|warn|block`); full closure is tracked in `docs/TASK_PACKAGES/TP-2026-03-02-p12-cross-domain-hardening-full-closure-a1.md`.
...
- `P4` closes only through `docs/TASK_PACKAGES/TP-2026-03-02-p4-expected-reply-full-closure-a1.md`.
- `P5b` closes only through `docs/TASK_PACKAGES/TP-2026-03-02-p5b-distributed-retrieval-backend-a1.md`.
- `P9` closes only through `docs/TASK_PACKAGES/TP-2026-03-02-p9-contract-oracle-full-closure-a1.md`.
