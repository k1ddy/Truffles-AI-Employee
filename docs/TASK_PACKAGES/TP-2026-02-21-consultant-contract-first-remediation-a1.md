...
- `P12 Cross-domain Hardening` partial: capability isolation tests exist (`truffles-api/tests/test_cross_domain_capability_isolation.py`), but no non-salon pack validation/eval found.
