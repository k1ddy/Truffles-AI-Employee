...
| Wave 4 Decomposition/perf | `partial` | Вынесены `OperationalKpi`, `FleetAttention`, `PortfolioCompanies` панели (`console-web/src/components/TenantsOperationalKpiPanel.tsx`, `console-web/src/components/TenantsFleetAttentionPanel.tsx`, `console-web/src/components/TenantsPortfolioCompaniesPanel.tsx`) | `tenants/page.tsx` всё ещё содержит крупные секции clients/change/decommission + action orchestration (`F4`) |
