...
- `Next block objective`: re-check whether `Wave31` / routing v2 is actually needed now that Wave33-Wave35 are locally closed.
- `First deterministic check command`: `cd /home/zhan/worktrees/2026-03-05-inbox-calendar-ux-reconstruction-a1 && rg -n "Wave31|Wave35|routing v2|UX-36" docs/TASK_PACKAGES/TP-2026-03-05-inbox-calendar-ux-reconstruction-a1.md docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave31-a1.md docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave35-a1.md docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`
- `Blocked-by conditions`: any regression in Wave33/Wave34/Wave35 surfaces, or any attempt to open routing v2 without owner-approved bounded inputs and real workflow evidence, blocks immediately.
