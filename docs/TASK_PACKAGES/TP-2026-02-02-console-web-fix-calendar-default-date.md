...
- Plan:
  ...
  2) Добавить unit-тест на форматирование даты с timezone offset.
...
- Checks:
  ...
  - unit-тест на formatDate (если есть jest/vitest; иначе добавить минимальный).
...
- Branch: `feat/2026-02-02-console-calendar-default-date`
- Worktree path: `/home/zhan/worktrees/2026-02-02-console-calendar-default-date`
