...
| UX-11 | P1 | API maintainability | `console.py` remains an overgrown router with mixed concerns. | Slow onboarding and high regression probability for Platform Admin APIs. | Wave12 extracted branch-change prepare/validation orchestration into `console_branch_changes.py` and reduced router LOC (`24365 -> 24351`) with deterministic evidence (`35 passed` + `branch_change 13 passed` + targeted e2e `2 passed`); references: `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-wave12-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-closure-review8-a705.md`. | Open (Mitigated wave12; closure-review8 required) |
| UX-12 | P1 | Provisioning UX complexity | `ProvisioningWizard.tsx` remains a large multi-domain component. | Hard to ship safe improvements fast across onboarding paths. | Wave12 extracted autopilot run-state/validation/service-toggle helpers into `provisioning-wizard-autopilot.ts` while keeping deterministic evidence green (`ProvisioningWizard.tsx=4365`, `35 passed` + `branch_change 13 passed` + targeted e2e `2 passed`); references: `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-wave12-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-closure-review8-a705.md`. | Open (Mitigated wave12; closure-review8 required) |
