...
| UX-11 | P1 | API maintainability | `console.py` remains an overgrown router with mixed concerns. | Slow onboarding and high regression probability for Platform Admin APIs. | Wave15 delegated publish/rollback runtime state transitions into `console_branch_changes` helpers and kept deterministic lane green (`35 passed` + `branch_change 21 passed`); merged-main closure decision still required via closure-review11. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave15-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-closure-review11-a705.md`. | Open (Mitigated wave15; closure-review11 required) |
| UX-12 | P1 | Provisioning UX complexity | `ProvisioningWizard.tsx` remains a large multi-domain component. | Hard to ship safe improvements fast across onboarding paths. | Wave15 delegated go-live approve/reject/waive payload validation into `provisioning-wizard-branch-actions` and preserved validation UX text with deterministic checks green (`35 passed` + `branch_change 21 passed`); merged-main closure decision still required via closure-review11. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave15-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-closure-review11-a705.md`. | Open (Mitigated wave15; closure-review11 required) |
