...
| UX-35 | P0 | Calendar operator surface density | Even after merged `Wave37`, the Calendar queue still feels inconsistent in live operator use: filter changes do not yet follow one explicit `draft -> applied` contract, and phone-entry guidance still lets the surface fight the operator instead of helping. | Operators still hesitate while filtering records and entering customer contacts, which keeps the primary booking path frustrating instead of fast and predictable. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave37-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-09-inbox-calendar-ux-reconstruction-wave38-a1.md`, `console-web/src/app/calendar/page.tsx`, `console-web/src/lib/queue-state.ts`, `console-web/e2e/calendar-operator.spec.ts`, `PR #959`. | Reopened under `Wave38` after merged `PR #959` |
| UX-36 | P0 | Operator workflow coverage gap | `Wave37` added a dedicated Calendar lane, but post-merge evidence shows the coverage is still incomplete: it does not yet prove filter synchronization, phone deletion/paste ergonomics, or edit/cancel lifecycle for existing bookings. | Technical create-flow proof can still go green while real operators remain blocked on correction and recovery flows. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave35-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave37-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-09-inbox-calendar-ux-reconstruction-wave38-a1.md`, `console-web/e2e/calendar-operator.spec.ts`, `console-web/e2e/inspect_case.spec.ts`, `console-web/src/app/calendar/page.tsx`, `PR #959`. | Reopened under `Wave38` until the new lifecycle matrix is green |
