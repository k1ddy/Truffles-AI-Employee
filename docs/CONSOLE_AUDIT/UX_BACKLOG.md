...
| UX-34 | P0 | Inbox operator surface density | `Заявки` first screen combines queue mode, saved-view/share management, search/owner filters, display prefs, advanced filters, persistence hints, and bulk flows in one rail surface. | Visual noise, unclear primary action, wrap/overlap risk, and slower operator handling. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave33-a1.md`, `console-web/src/components/CaseList.tsx`, `PR #952`. | In review (fixed locally; `PR #952`) |
| UX-35 | P0 | Calendar operator surface density | `Записи` mixes queue mode/lane, filters, saved-view/share management, and inline governance/action stacks on the same first-screen control surface. | Crowded queue triage, weak action hierarchy, and excessive vertical growth inside booking cards. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave34-a1.md`, `console-web/src/app/calendar/page.tsx`, `PR #953`. | In review (fixed locally; `PR #953`) |
| UX-36 | P0 | Operator workflow coverage gap | Backend contracts for queue state, saved views, follow-up governance, and routing profiles are green, but frontend workflow/layout proof is incomplete; targeted operator Playwright originally passed `4/5`, with one failing width assertion on Inbox. | Interaction regressions can ship while API tests stay green. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave35-a1.md`, `console-web/e2e/inspect_case.spec.ts`, targeted proof lane `7 passed`, `PR #954`. | In review (fixed locally; `PR #954`) |
