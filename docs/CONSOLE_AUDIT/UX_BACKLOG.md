...
| UX-11 | P1 | API maintainability | `console.py` remains an overgrown router with mixed concerns. | Slow onboarding and high regression probability for Platform Admin APIs. | Wave16 delegated publish-success state mutation into `console_branch_changes` helper and closure-review12 on merged-main kept fail-closed status (`console.py=24380`, `ProvisioningWizard.tsx=4338`, `35 passed` + `branch_change 23 passed`): `Open (Mitigated wave16; wave17 required)`. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave16-a705.md`, `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-closure-review12-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-wave17-a705.md`, `https://github.com/k1ddy/Truffles-AI-Employee/pull/916`. | Open (Mitigated wave16; wave17 required) |
| UX-12 | P1 | Provisioning UX complexity | `ProvisioningWizard.tsx` remains a large multi-domain component. | Hard to ship safe improvements fast across onboarding paths. | Wave16 delegated shared go-live mutate submit flow into `provisioning-wizard-branch-actions` and closure-review12 on merged-main kept fail-closed status (`console.py=24380`, `ProvisioningWizard.tsx=4338`, `35 passed` + `branch_change 23 passed`): `Open (Mitigated wave16; wave17 required)`. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave16-a705.md`, `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-closure-review12-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-wave17-a705.md`, `https://github.com/k1ddy/Truffles-AI-Employee/pull/916`. | Open (Mitigated wave16; wave17 required) |
