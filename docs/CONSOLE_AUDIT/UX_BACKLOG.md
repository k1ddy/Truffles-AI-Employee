...
| --- | --- | --- | --- | --- | --- |
| UX-01 | Calendar | Error banner renders raw JSON payload for specialists load failure. | Non-user-friendly error output, potential data leakage. | `console-web/src/app/calendar/page.tsx` (specialistsError details). | Fixed |
