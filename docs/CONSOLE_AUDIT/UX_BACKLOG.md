...
| --- | --- | --- | --- | --- | --- |
| UX-01 | Calendar | Error banner renders raw JSON payload for specialists load failure. | Non-user-friendly error output, potential data leakage. | `console-web/src/app/calendar/page.tsx` (specialistsError details), PR #500, CI https://github.com/k1ddy/Truffles-AI-Employee/actions/runs/21580726422. | Fixed |
