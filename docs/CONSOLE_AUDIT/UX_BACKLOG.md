...
| UX-11 | P1 | API maintainability | `console.py` remains an overgrown router with mixed concerns. | Slow onboarding and high regression probability for Platform Admin APIs. | Current wave10 LOC (`truffles-api/app/routers/console.py`: `24366`); wave10 extraction delivered in `truffles-api/app/services/console_branch_changes.py` with retained deterministic evidence (`35 passed` + `branch_change 10 passed`) and wave10 artifact: `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-wave10-a705.md`; follow-up closure contract: `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-closure-review6-a705.md`. | Open (Mitigated wave10; closure-review6 required) |
| UX-12 | P1 | Provisioning UX complexity | `ProvisioningWizard.tsx` remains a large multi-domain component. | Hard to ship safe improvements fast across onboarding paths. | Current wave10 LOC (`console-web/src/components/ProvisioningWizard.tsx`: `4423`); wave10 extraction delivered in `console-web/src/components/provisioning-wizard-account-actions.ts` with retained acceptance evidence (`build + targeted e2e 2 passed`) and wave10 artifact: `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-wave10-a705.md`; follow-up closure contract: `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-closure-review6-a705.md`. | Open (Mitigated wave10; closure-review6 required) |
