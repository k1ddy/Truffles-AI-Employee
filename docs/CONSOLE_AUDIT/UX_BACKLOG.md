...
| UX-35 | P0 | Calendar operator surface density | `Записи` required a second-pass rebuild after merged Wave36 because booking creation still hid time behind implicit prerequisites and mixed operator actions with governance noise. | Operators could not reliably create bookings fast, which made the Calendar tab operationally unsafe until the flow was rebuilt around explicit steps and blocked states. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave36-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave37-a1.md`, `console-web/src/app/calendar/page.tsx`, `console-web/e2e/calendar-operator.spec.ts`, `console-web/e2e/inspect_case.spec.ts`, `PR #958`. | Local Wave37 closeout complete; keep watch until PR merge |
| UX-36 | P0 | Operator workflow coverage gap | Calendar acceptance needed a dedicated lane that proves the real operator journey: discover time, recover from blocked states, avoid wrong inputs, and close no-show follow-up safely. | Without that lane, technical happy paths can still ship non-operable Calendar behavior to main. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave35-a1.md`, `docs/TASK_PACKAGES/TP-2026-03-08-inbox-calendar-ux-reconstruction-wave37-a1.md`, `console-web/e2e/calendar-operator.spec.ts`, `console-web/e2e/inspect_case.spec.ts`, `console-web/src/app/calendar/page.tsx`, `PR #954`. | Local Wave37 closeout complete; keep watch until PR merge |
