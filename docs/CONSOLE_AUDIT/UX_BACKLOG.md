...
| UX-34 | P0 | Inbox operator surface density | `Заявки` first screen combines queue mode, saved-view/share management, search/owner filters, display prefs, advanced filters, persistence hints, and bulk flows in one rail surface. | Visual noise, unclear primary action, wrap/overlap risk, and slower operator handling. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `console-web/src/components/CaseList.tsx:1961`, `console-web/src/components/CaseList.tsx:2054`, `console-web/src/components/CaseList.tsx:2404`, `console-web/src/components/CaseList.tsx:2710`, `console-web/test-results/inspect_case-inspect-first-case-chromium/error-context.md`. | Open |
| UX-35 | P0 | Calendar operator surface density | `Записи` mixes queue mode/lane, filters, saved-view/share management, and inline governance/action stacks on the same first-screen control surface. | Crowded queue triage, weak action hierarchy, and excessive vertical growth inside booking cards. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `console-web/src/app/calendar/page.tsx:1634`, `console-web/src/app/calendar/page.tsx:1740`, `console-web/src/app/calendar/page.tsx:2258`. | Open |
| UX-36 | P0 | Operator workflow coverage gap | Backend contracts for queue state, saved views, follow-up governance, and routing profiles are green, but frontend workflow/layout proof is incomplete; targeted operator Playwright passed `4/5`, with one failing width assertion on Inbox. | Interaction regressions can ship while API tests stay green. | `docs/CONSOLE_AUDIT/artifacts/2026-03-08-inbox-calendar-ux-logic-audit-a1.md`, `console-web/e2e/inspect_case.spec.ts:1319`, `console-web/test-results/inspect_case-inspect-first-case-chromium/error-context.md`, `truffles-api/tests/test_console_saved_views_api.py`, `truffles-api/tests/test_console_queue_state_api.py`, `truffles-api/tests/test_calendar_noshow_followup_router.py`, `truffles-api/tests/test_console_cases_helpers.py`, `truffles-api/tests/test_console_routing_profiles_api.py`. | Open |
