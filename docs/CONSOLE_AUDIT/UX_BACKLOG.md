...
| UX-11 | P1 | API maintainability | `console.py` remains an overgrown router with mixed concerns. | Slow onboarding and high regression probability for Platform Admin APIs. | Wave19 delegated repeated branch-change context resolution into `console_branch_changes.get_branch_for_change_context` and preserved deterministic parity (`console.py=24396`, `ProvisioningWizard.tsx=4296`, `35 passed` + `branch_change 29 passed`); closure-review15 fail-closed decision remains required on merged-main evidence. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave19-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-closure-review15-a705.md`. | Open (Mitigated wave19; closure-review15 required) |
| UX-12 | P1 | Provisioning UX complexity | `ProvisioningWizard.tsx` remains a large multi-domain component. | Hard to ship safe improvements fast across onboarding paths. | Wave19 delegated wizard reset-state assembly into `createProvisioningWizardResetState` and preserved deterministic parity (`console.py=24396`, `ProvisioningWizard.tsx=4296`, `35 passed` + `branch_change 29 passed`); closure-review15 fail-closed decision remains required on merged-main evidence. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave19-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-closure-review15-a705.md`. | Open (Mitigated wave19; closure-review15 required) |
