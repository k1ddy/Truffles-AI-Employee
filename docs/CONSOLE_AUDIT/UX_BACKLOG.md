...
| UX-11 | P1 | API maintainability | `console.py` remains an overgrown router with mixed concerns. | Slow onboarding and high regression probability for Platform Admin APIs. | Wave20 executed bounded extraction by moving control-tower drift/readiness board orchestration from router to service boundaries; branch deterministic evidence now meets closure threshold (`console.py=24353 <= 24396`, wizard unchanged `4287`). Final status remains fail-closed until merged-main closure-review16. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave20-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-closure-review16-a705.md`. | Open (Mitigated wave20; closure-review16 required) |
| UX-12 | P1 | Provisioning UX complexity | `ProvisioningWizard.tsx` remains a large multi-domain component. | Hard to ship safe improvements fast across onboarding paths. | Wave20 stayed backend-focused to close closure criterion `C1`; wizard threshold remains inside contract (`4287 <= 4296`). Final closure decision is deferred to closure-review16 on merged-main evidence. References: `docs/CONSOLE_AUDIT/artifacts/2026-03-05-uvc-tech-debt-decomposition-wave20-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-05-uvc-ux-tech-debt-decomposition-closure-review16-a705.md`. | Open (Mitigated wave20; closure-review16 required) |
