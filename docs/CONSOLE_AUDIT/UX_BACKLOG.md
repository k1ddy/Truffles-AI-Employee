...
| UX-11 | P1 | API maintainability | `console.py` remains an overgrown router with mixed concerns. | Slow onboarding and high regression probability for Platform Admin APIs. | Closure-review8 on merged-main after wave12 (`PR #906`) kept residual open: `console.py=24365`, deterministic lane green (`35 passed` + `branch_change 13 passed`); references: `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-closure-review8-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-wave13-a705.md`. | Open (Mitigated wave12; wave13 required) |
| UX-12 | P1 | Provisioning UX complexity | `ProvisioningWizard.tsx` remains a large multi-domain component. | Hard to ship safe improvements fast across onboarding paths. | Closure-review8 on merged-main after wave12 (`PR #906`) kept residual open: `ProvisioningWizard.tsx=4365`, deterministic lane green (`35 passed` + `branch_change 13 passed`); references: `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-closure-review8-a705.md`, `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-wave13-a705.md`. | Open (Mitigated wave12; wave13 required) |
