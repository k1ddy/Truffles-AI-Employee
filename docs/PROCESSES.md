...
- **Техподдержка после онбординга** — обработка обращений после go-live: каналы, сроки, эскалации. Поток handover описан в разделах 2.2-2.3; регламент поддержки — черновик `Business/Support/Регламент_техподдержки.md` (DERIVED).
- **Договор** — юридическая база оказания услуг (предмет, оплата, ответственность, SLA/поддержка, обработка данных и приложения). В репо есть шаблон `Business/Legal/ДОГОВОР.md` (DERIVED; не канон до утверждения/подписания).
...
- Договор на услуги, NDA, счет на оплату, политика обработки данных, согласие на обработку данных, ограничение ответственности — финальные/согласованные версии (или включены в договор).
- SLA, акт приёма-передачи и политика возврата — финальные версии при наличии соответствующих обещаний/условий в тарифе.
...
- Есть согласованный регламент поддержки (шаблон есть; финальная версия должна быть утверждена).
...
- Критичные документы до старта: договор, NDA, счет, политика обработки данных, согласие на обработку данных, ограничение ответственности — есть шаблоны, но не финальные/подписанные версии.
- SLA, акт приёма-передачи, политика возврата, disclosure об автоматизированных ответах — шаблоны есть, но не финальные/согласованные версии.
- Регламент техподдержки, чеклист запуска, инструкция для клиента — есть черновики, но не финальные документы.

### 2.6 Business процесс: договор → онбординг → поддержка (шаблон)

**Цель:** единый путь от подписания до поддержки без непроверенных обещаний.

**Входы:**
- согласованный договор и приложения;
- подтверждённая оплата;
- заполненный бриф и данные клиента (pack).

**Процесс:**
1) **Сделка:** согласовать договор/приложения и подписать; выставить счёт; подтвердить оплату.
2) **Онбординг:** собрать бриф, заполнить pack, настроить instance_id/phone, подключить Telegram/Console.
3) **Go/No-Go:** проверить юридическую готовность и onboarding‑gate (раздел 2.5).
4) **Go-live:** запустить на одном филиале и выполнить контрольный диалог.
5) **Поддержка:** принимать обращения по согласованным каналам; изменения данных — через согласование и обновление pack.

**Артефакты (ссылки):**
- Юридические шаблоны: `Business/Legal/*`.
- Онбординг: `Business/Onboarding/Чеклист_запуска.md`, `Business/Onboarding/Инструкция_клиента.md`.
- Поддержка: `Business/Support/Регламент_техподдержки.md`.
