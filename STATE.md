...
- DONE (local/docs+planning): dedicated continuation blocks created for remaining architecture gaps with mandatory gates and RCA/reuse/release-safety: `TP-2026-03-02-p4-expected-reply-routing-decouple-a1` (`P4` partial) and `TP-2026-03-02-p5b-distributed-retrieval-backend-a1` (`P5` residual closure path).
