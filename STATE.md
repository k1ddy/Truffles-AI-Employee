...
- DONE: Provider Gateway service (shadow container) — Task Package `docs/TASK_PACKAGES/TP-2026-01-27-provider-gateway-service.md`; local image `truffles-provider-gateway:20260127` built from `truffles-api/Dockerfile`, container `truffles-provider-gateway` via `scripts/restart_provider_gateway.sh` (port 8011); health `/tmp/provider_gateway_health_20260127_151028.json`; test `pytest -q truffles-api/tests/test_provider_gateway_app.py`.
