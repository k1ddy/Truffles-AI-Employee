...
**Что сделали:**
- В booking/truth-gate добавлен bypass для opt‑out и фрустрации (чтобы “не пиши мне” не становилось именем).
- При opt‑out во время booking — сбрасываем booking context + service hint.
- Добавили тест на составной opt‑out (с матом/шумом).
...
- Диагноз: booking flow обрабатывал сообщение как слот “имя” и эскалировал.
- Решение: bypass booking/truth-gate для opt‑out/фрустрации + сброс booking контекста.
