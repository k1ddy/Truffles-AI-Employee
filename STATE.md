...
- DONE (local+tests, pending PR merge): `UVC-UX-TECH-DEBT-DECOMPOSITION-WAVE6-A705` delivered as next bounded structural split for `UX-11/UX-12`: extracted fleet lifecycle/payment/service resolver layer into `truffles-api/app/services/console_fleet_state.py` with deterministic tests `truffles-api/tests/test_console_fleet_state.py` (`24 passed` with retained wave coverage), extracted provisioning JSON payload handlers into `console-web/src/components/provisioning-wizard-json-payloads.ts`, reduced monolith LOC (`console.py: 24897 -> 24743`, `ProvisioningWizard.tsx: 4679 -> 4617`), and revalidated targeted contracts (`py_compile`, frontend lint/build, targeted platform-admin e2e `26 passed`, `session_check`). Evidence: `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-wave6-a705.md`, `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-wave6-a705.md`, `docs/CONSOLE_AUDIT/UX_BACKLOG.md`, `docs/REPORTS/2026-02-22-universal-control-plane-v1-master-a500.md`.
