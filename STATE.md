...
- Eval‑харнес поддерживает `turns` и `EVAL_TIER=long`; добавлены long‑кейсы E401–E406 (truffles-api/tests/test_demo_salon_eval.py:75-85,564-706; truffles-api/app/knowledge/demo_salon/EVAL.yaml:4016-4144). Тесты: `docker exec -i truffles-api pytest /app/tests/test_demo_salon_eval.py -q` PASS (113.0s); `docker exec -i truffles-api pytest /app/tests/test_demo_salon_eval.py -q -o EVAL_TIER=long` PASS (111.7s). `/admin/version` {"git_commit":"7b078da5f702979d683105cc289f0921d6915739","build_time":"2026-01-03T07:12:41Z"}.
