...
- OBS-DEV router observability merged (PR #62). CI main PASS: https://github.com/k1ddy/Truffles-AI-Employee/actions/runs/20748951726. Прод `/admin/version`: `{"version":"main","git_commit":"03613c2f3001a4426cd8d08c1e7a121314bf76b4","build_time":"2026-01-06T12:57:11Z"}`. OBS-OPS 7d SQL: total=372, eligible=10, used_on_eligible=0 (0%), ineligible=8; router_skipped_reason: none=10, expected_reply_shortcircuit=6, pending=2, (null)=354 (нет ключей у старых сообщений).
- Live-check M1 (memory fallback после перебивки) PARTIAL: conv_id `37b1a2d6-a4f8-4ae0-9169-3e44e405478d`. Шаг 3 msg `ff288ee0-834a-44a2-9dfa-a0447e8401b8`: decision_meta info_sections=["address","hours","parking"], expected_reply_type=time. Шаг 4 msg `4e3d7189-75e5-465e-a660-aa85e4f1c6d7`: expected_reply_shortcircuit=true, answer_value="в субботу вечером", router_skipped_reason=expected_reply_shortcircuit, session_memory.pending_slots включает datetime; trace question_contract expected_reply_type=time. Фактически action=clarify_limit/escalate и decision_meta expected_reply_type=name; session_memory_used flag NOT FOUND (есть session_memory_update/trace).
- Live-check M2 (memory reset) FAIL: conv_id `847bc81f-979b-4b8a-9cab-9eab6caf8d8a`. Шаг 3 msg `93216a63-0320-41b6-ac5e-86d862597b41`: session_memory_reset=explicit_reset, но action=clarify_limit/escalate → pending. Шаг 4 msg `c0afdce3-a397-4666-8f17-af7fdbe91f99`: pending_wait (no info_bundle).
- Live-check M3 PASS: conv_id `7dccd5a7-1ccb-4057-bf01-f7291c53fb5d`, msg `7d992755-a3af-46b1-8bd2-926faf30f00a`: time_only_guard=true, intent=service_clarify, trace stage time_only_guard decision=service_clarify.
