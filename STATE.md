...
- GAP: CI build-push failed on main after Dockerfile switched to repo-root context (missing `truffles-api/*` + `contracts/`). Evidence: https://github.com/k1ddy/Truffles-AI-Employee/actions/runs/21564937069 (job `build-push`).
