...
- PLAN: TP‑C Destructive safeguards (confirmation flow for destructive console actions) — Task Package `docs/TASK_PACKAGES/TP-2026-01-26-control-plane-destructive-safeguards.md`; local checks: `pytest -q truffles-api/tests/test_console_confirmations.py`, `npm --prefix console-web run lint`, `npm --prefix console-web run generate:api` (all OK). Evidence pending CI.
...
- PLAN: Knowledge Snapshot consult cutover (fallback → strict) — Task Package `docs/TASK_PACKAGES/TP-2026-01-27-knowledge-snapshot-consult-cutover.md`.
