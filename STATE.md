...
- GAP: Pack-Compiler DoD not green — chaos-sim rerun still failing (pending_action_mismatch/state_mismatch/action_mismatch/ood_false_positive); HTTP 500 fixed. Evidence: `/tmp/chaos_pack_compiler_rerun` (`report.md`, `failures.partial.jsonl`, `summary.json`).
