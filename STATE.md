...
- `POST /console/v1/cases/{id}/take` вызван дважды с одним `Idempotency-Key`.
...
- HTTP (same key twice): `Idempotency-Key=idem-test-9aa34524-e91c-43f4-a4d0-af9608cb7a7c` → оба ответа `200` с одинаковым body.
- SQL: `select id, client_id, agent_id, scope, request_hash, response_status, created_at from console_idempotency_keys where idempotency_key='idem-test-9aa34524-e91c-43f4-a4d0-af9608cb7a7c';`
