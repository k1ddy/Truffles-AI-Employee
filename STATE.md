...
- DONE: Calendar past dates toggle (no min lock) — evidence: PR #507 https://github.com/k1ddy/Truffles-AI-Employee/pull/507, CI https://github.com/k1ddy/Truffles-AI-Employee/actions/runs/21591186760.
...
- PLAN: Consent/анонимизация/retention + pack candidates approvals (DEC-022) — Task Package `docs/TASK_PACKAGES/TP-2026-02-02-learning-consent-pack-candidates.md`.
- PLAN: REQUIREMENTS update for DEC-021/DEC-022 (minimum data contract + consent/anon) — Task Package `docs/TASK_PACKAGES/TP-2026-02-02-requirements-consent-canon.md`.
