...
- CI (main@290058b) green: https://github.com/k1ddy/Truffles-AI-Employee/actions/runs/20675182236. Предыдущий прогон (20674885954) падал на `secret-scan` из-за `System.Text.EncoderFallbackException: Unable to translate Unicode character \\uD83E...` (job 59361181850); rerun устранил, build-push/deploy проходят.
- Прод: `/admin/version` → `{"version":"main","git_commit":"290058b2203a04c2b94e3a6975e2c9d92a22dd0c","build_time":"2026-01-03T09:06:37Z"}` (команда `docker exec -i truffles-api python - <<'PY' ...`).
