...
- DONE: Console Insights доступ для platform_admin (canon + RBAC) — evidence: `SPECS/CONTROL_PLANE.md`, `console-web/src/lib/api-client.ts`, `docs/CONSOLE_AUDIT/CANON_VS_IMPLEMENTED.md`, `docs/CONSOLE_AUDIT/pages/insights.md`, `docs/CONSOLE_AUDIT/roles/platform_admin.md`, `/tmp/console_web_lint_insights_platformadmin_20260204.txt`.
