...
**NOW (1 экран)**
- DONE (local+tests, pending PR merge): `UVC-UX-TECH-DEBT-DECOMPOSITION-WAVE4-A705` delivered as next bounded structural split for `UX-11/UX-12` after closeout merge: extracted onboarding readiness hard-gate slice from `truffles-api/app/routers/console.py` into `truffles-api/app/services/console_onboarding_readiness.py` with deterministic tests `truffles-api/tests/test_console_onboarding_readiness.py` (`4 passed`), extracted provisioning readiness timeline/scorecard view from `console-web/src/components/ProvisioningWizard.tsx` into `console-web/src/components/provisioning-wizard-readiness-panel.tsx`, and revalidated UVC contract lane (`console-web build`, targeted e2e `26 passed`). Evidence: `docs/TASK_PACKAGES/TP-2026-03-04-uvc-ux-tech-debt-decomposition-wave4-a705.md`, `docs/CONSOLE_AUDIT/artifacts/2026-03-04-uvc-tech-debt-decomposition-wave4-a705.md`, `docs/CONSOLE_AUDIT/UX_BACKLOG.md`, `docs/REPORTS/2026-02-22-universal-control-plane-v1-master-a500.md`.
