...
- CI (main@4659316) green: https://github.com/k1ddy/Truffles-AI-Employee/actions/runs/20674885954 (rerun). Первый прогон упал на `secret-scan` из-за `System.Text.EncoderFallbackException: Unable to translate Unicode character \\uD83E...` (job 59361181850); rerun прошёл, build-push/deploy выполнены.
- Прод: `/admin/version` → `{"version":"main","git_commit":"4659316983aa111cfe123371d8fcdd0d38a207c3","build_time":"2026-01-03T08:48:46Z"}` (команда `docker exec -i truffles-api python - <<'PY' ...`).
