...
- PLAN: Phase 2B Provisioning API — branch `feat/control-plane-phase2-provisioning`; Task Package `docs/TASK_PACKAGES/TP-2026-01-24-control-plane-phase2-provisioning.md`.
