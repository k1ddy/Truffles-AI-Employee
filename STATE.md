...
**NOW (1 экран)**
- PLAN: Inbox быстрые ответы не загружаются + двойной бордер/скругления у чата (Console Inbox UX v3). Task Package: `docs/TASK_PACKAGES/TP-2026-01-30-inbox-macros-fix.md`. Evidence: user report 2026-01-30 (build `8af21ed`); migration `017_add_console_macros.sql` applied (table created) `/tmp/console_macros_migration_20260130.txt`. UI fix pending CI/deploy.
