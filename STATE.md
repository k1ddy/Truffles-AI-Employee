...
- GAP: console-e2e-live login fails waiting for Keycloak provider form — CI https://github.com/k1ddy/Truffles-AI-Employee/actions/runs/21421137619 (console-e2e-live, `locator('form[action*="keycloak"]')` timeout in `console-web/e2e/global-setup.ts`).
