...
- PLAN: Vertical pack readiness + minimum data contract + safe-mode gate (DEC-021) — Task Package `docs/TASK_PACKAGES/TP-2026-02-02-vertical-pack-canon.md`.
- PLAN: Consent/анонимизация/retention для улучшений (DEC-022) — Task Package `docs/TASK_PACKAGES/TP-2026-02-02-vertical-pack-canon.md`.
