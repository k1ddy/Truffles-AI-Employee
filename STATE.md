...
- GAP: Pack-Compiler DoD not green — chaos-sim failures (action_mismatch/ood_false_positive/pending_action_mismatch/state_mismatch; HTTP 500 fixed via time-only guard, rerun pending).
