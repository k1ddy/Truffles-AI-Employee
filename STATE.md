...
- TEST_MODE=1, OUTBOUND_ALLOWLIST_JIDS=77015705555@s.whatsapp.net,+77015705555 (тестовый номер) выставлены в `truffles-api/.env`; контейнер перезапущен с `ghcr.io/k1ddy/truffles-ai-employee:main` (2026-01-02).
