...
- GAP: admin/admin login shows AccessDenied “Эта роль не имеет доступа к Inbox.” while `/console/v1/me` returns `agent.role=platform_admin` — evidence: `/home/zhan/screenshots/console-admin-deny-2026-01-27T11-04-53-681Z/01-home.png`, `/tmp/admin_admin_me.json`.
